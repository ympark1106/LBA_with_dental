...
def random_crop_teeth(json_path, image_root, output_folder, teeth_symbol, num_crops, margin):
    ...
    image_ids_not_disease = [ann['image_id'] for ann in data['annotations'] if ann['category_id'] != 34 and ann['category_id'] != 35 and ann['category_id'] != 38 and ann['category_id'] != 39]
    # 34랑 35, 38, 41 아닌 이미지들만
...
if __name__ == "__main__":
    ...
    output_folder = "/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/not_K01_K02_K05_K07_images"
    teeth_symbol = '#'
    num_crops = 200
    margin = 30
...
cropped_image_path = '/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/not_K01_K02_K05_K07_images'
print("Number of cropped images:", len(os.listdir(cropped_image_path)))