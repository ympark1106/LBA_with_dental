...
from loader_label_9 import TeethDataset   # 수정
from loader_label_9 import transforms     # 수정
...
def evaluate_model(model, dataloader, criterion, device, confmat=None):
    ...
    with torch.no_grad():
        for images, labels in dataloader:
            ...
            # 업데이트
            if confmat is not None:
                # confmat.update(preds.int(), labels.int())
...
model_save_directory = '/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/disease_detection_MultiLabelCL/saved_models_total'
