...
class TeethDataset(Dataset):
    def __init__(self, transform=None):
        self.path = '/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/cropped_images/cropped_disease_images'
        # self.categories = ['cropped_K01_images', 'cropped_K02_images', 'cropped_K05_images', 'cropped_K07_images', 'not_K01_K02_K05_K07_images']
        self.files = []
        self.labels = []  
        self.file_label_dic = {}
        self.file_path_dic = {}
        ...
        category_files = [[] for _ in range(len(self.categories))] # 5개의 카테고리에 대한 파일 리스트
