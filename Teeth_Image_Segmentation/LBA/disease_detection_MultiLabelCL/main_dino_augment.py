...
from loader_dino_9 import TeethDataset, split_data   # 수정
from loader_dino_9 import transforms    # 수정
...
# model = CustomDINOV2(num_classes=5).to(device)  # 수정
...
model_save_directory = '/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/disease_detection_MultiLabelCL/saved_dinov2_margin90'
