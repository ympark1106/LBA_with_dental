...
from loader_label_9_order_copy import TeethDataset   # 수정
from loader_label_9_order_copy import transforms     # 수정
from model import ResNet50 
from torchmetrics.classification import MultilabelConfusionMatrix
from loss_functions.asl_losses import AsymmetricLossOptimized
...
file_paths = TeethDataset.file_paths
labels = TeethDataset.labels

dataset = TeethDataset(file_paths=file_paths, labels=labels, transform=transform)
# print(len(dataset)) 
# exit()
...
model_save_directory = '/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/disease_detection_MultiLabelCL/saved_models_balanced_2'
