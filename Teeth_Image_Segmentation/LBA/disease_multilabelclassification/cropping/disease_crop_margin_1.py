...
def find_decay_teeth(json_path, image_root, output_folder, teeth_category_symbols, margin):
    ...
    image_ids_category_34 = [ann['image_id'] for ann in data['annotations'] if ann['category_id'] == 34]
    print("Image_ids with category_id 34:", image_ids_category_34)
    print(len(image_ids_category_34))

    for image_id in image_ids_category_34:
        if image_id >= 206:
            bbox_category_34_all = [ann['bbox'] for ann in data['annotations'] if ann['image_id'] == image_id and ann['category_id'] == 34]
            print("Image ID:", image_id, "\nBbox for category_id = 34:", bbox_category_34_all)
            
            for bbox_category_34 in bbox_category_34_all:
                print("Bbox for category_id = 34:", bbox_category_34)
                ...
                for tooth_category_id in teeth_category_ids:
                    ...
                    for bbox_tooth in bbox_teeth:
                        ...
                        if is_bbox_contained(bbox_tooth, bbox_category_34):
...
if __name__ == "__main__":
    ...
    output_folder = "/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/cropped_images/cropped_K01_images_margin150"
...
cropped_image_path = '/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/cropped_images/cropped_K01_images_margin150'
