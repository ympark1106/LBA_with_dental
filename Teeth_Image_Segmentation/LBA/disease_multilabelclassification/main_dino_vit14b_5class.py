...
from loader import loader_dino_5class
...
train_files, train_labels, val_files, val_labels, test_files, test_labels = loader_dino_5class.split_data(parent_dir, categories, split_ratios)

train_dataset = loader_dino_5class.TeethDataset(train_files, train_labels, transform, augment=True)
val_dataset = loader_dino_5class.TeethDataset(val_files, val_labels, transform, augment=False)
test_dataset = loader_dino_5class.TeethDataset(test_files, test_labels, transform, augment=False)

train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True)
val_loader = DataLoader(val_dataset, batch_size=32, shuffle=False)
test_loader = DataLoader(test_dataset, batch_size=32, shuffle=False)

model = model_dino_vit14b.CustomDINOV2(num_classes=5).to(device)  
...
model_save_directory = '/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/disease_multilabelclassification/checkpoints/saved_dinovit14b_5class_0408'
