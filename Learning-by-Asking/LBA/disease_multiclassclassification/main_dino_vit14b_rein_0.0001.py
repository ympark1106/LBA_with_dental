...
import model_dino_vit14b_rein_1   # 수정
...
model = model_dino_vit14b_rein_1.CustomDINOV2(num_classes=9, depth=12, embed_dim=768, patch_size=16).to(device)
print(model)
...
model_save_directory = '/home/gpu/Workspace/youmin/Learning-by-Asking/LBA/disease_multiclassclassification/checkpoints/9_saved_dinovit14b_rein_weight_0.0001_0425' # 'saved_dinovit14b
