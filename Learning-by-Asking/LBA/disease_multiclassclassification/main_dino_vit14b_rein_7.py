...
import model_dino_vit14b_rein_7   # 수정
...
model = model_dino_vit14b_rein_7.CustomDINOV2(num_classes=7, depth=12, embed_dim=768, patch_size=16).to(device) # 수정
print(model)
...
model_save_directory = '/home/gpu/Workspace/youmin/Learning-by-Asking/LBA/disease_multiclassclassification/checkpoints/7_saved_dinovit14b_rein_weight_0501' # 'saved_dinovit14b
...
for epoch in range(max_epoch):
    ...
    val_confmat = MulticlassConfusionMatrix(num_classes=7) # 수정
