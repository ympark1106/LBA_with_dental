...
def find_decay_teeth(json_path, image_root, output_folder, teeth_category_symbols, margin):
    ...
    image_ids_category_36 = [ann['image_id'] for ann in data['annotations'] if ann['category_id'] == 36]
    print("Image_ids with category_id 36:", image_ids_category_36)
    print(len(image_ids_category_36))

    for image_id in image_ids_category_36:
        if image_id >= 206:
            bbox_category_36_all = [ann['bbox'] for ann in data['annotations'] if ann['image_id'] == image_id and ann['category_id'] == 36]
            print("Image ID:", image_id, "\nBbox for category_id = 36:", bbox_category_36_all)
            
            for bbox_category_36 in bbox_category_36_all:
                print("Bbox for category_id = 36:", bbox_category_36)
                ...
                for tooth_category_id in teeth_category_ids:
                    ...
                    for bbox_tooth in bbox_teeth:
                        ...
                        if is_bbox_contained(bbox_tooth, bbox_category_36):
...
if __name__ == "__main__":
    ...
    output_folder = "/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/cropped_images/cropped_K03_images_margin150"
...
cropped_image_path = '/home/gpu/Workspace/youmin/Teeth_Image_Segmentation/LBA/cropped_images/cropped_K03_images_margin150'
