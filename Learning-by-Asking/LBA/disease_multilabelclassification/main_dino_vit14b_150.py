...
from model import model_dino_vit14b_9   # 수정
...
model = model_dino_vit14b_9.CustomDINOV2(num_classes=9).to(device)  
...
model_save_directory = '/home/gpu/Workspace/youmin/Learning-by-Asking/LBA/disease_multilabelclassification/checkpoints/saved_dinovit14b_0.001_0416' # 'saved_dinovit14b
...
for epoch in range(100):
    ...
    for images, labels in train_loader:
        ...
        outputs = model(images)
        preds = torch.sigmoid(outputs) > 0.25
        loss = criterion(outputs, labels)
        loss.backward()
        # print(loss)
        optimizer.step()
