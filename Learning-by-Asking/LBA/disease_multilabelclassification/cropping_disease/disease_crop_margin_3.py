...
def find_decay_areas(json_path, image_root, output_folder):
    ...
    image_ids_with_decay = [ann['image_id'] for ann in data['annotations'] if ann['category_id'] in [36]]
    print("Image_ids with category_id 36:", image_ids_with_decay)
    print(len(image_ids_with_decay))

    for image_id in set(image_ids_with_decay):
        decay_bboxes = [ann['bbox'] for ann in data['annotations'] if ann['image_id'] == image_id and ann['category_id'] in [36]]
        print("Image ID:", image_id, "\nBbox for category_id = 36:", decay_bboxes)
...
if __name__ == "__main__":
    ...
    output_folder = "/home/gpu/Workspace/youmin/Learning-by-Asking/LBA/cropped_disease_images/cropped_K03_images"
    if not os.path.exists(output_folder):
        os.makedirs(output_folder)

    find_decay_areas(json_path, root, output_folder)

cropped_image_path = "/home/gpu/Workspace/youmin/Learning-by-Asking/LBA/cropped_disease_images/cropped_K03_images"
